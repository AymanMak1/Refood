            ...
            <div class="container">
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-12 col-lg-6 order-1 order-lg-2">
                        <!-- Discover Text -->
                        <div class="discover-text pt-4 pt-lg-0 px-0 px-lg-4"  data-aos="fade-left" data-aos-duration="1000"  data-aos-delay="300">
                            <h2 class="pb-4">Refood Vision & Business Values</h2>
                            <!-- Check List -->
                            <ul class="check-list">
                                <li class="py-1">
                                    <!-- List Box -->
